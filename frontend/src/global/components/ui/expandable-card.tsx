...
import { Card, CardContent, CardFooter, CardHeader } from "@/global/components/ui/card";
import { Badge } from "@/global/components/ui/badge";
import { Button } from "@/global/components/ui/button";
import { Avatar, AvatarFallback, AvatarImage } from "@/global/components/ui/avatar";
import { Progress as ProgressBar } from "@/global/components/ui/progress";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/global/components/ui/tooltip";
import { useExpandable } from "@/global/hooks/use-expandable";
...
export function ExpandableCard({ title, progress, dueDate, contributors, tasks, githubStars, openIssues }: CardProps) {
			...
			<CardHeader className="space-y-1">
				<div className="flex justify-between items-start w-full">
					<div className="space-y-2">
						<Badge
							variant="secondary"
							className={progress === 100 ? "bg-green-100 text-green-600" : "bg-blue-100 text-blue-600"}
						>
